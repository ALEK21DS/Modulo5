...
class App:
    def __init__(self, root):
        ...
        self.laptops = []
        self.imagenes = [
            "C:\\Users\\darck\\Documents\\Krakedev\\Programacion_Brandon-modulo5\\POO\\Clases\\img\\asus.jpg",
            "C:\\Users\\darck\\Documents\\Krakedev\\Programacion_Brandon-modulo5\\POO\\Clases\\img\\legion.jpg",
            "C:\\Users\\darck\\Documents\\Krakedev\\Programacion_Brandon-modulo5\\POO\\Clases\\img\\msi.jpg",
            "C:\\Users\\darck\\Documents\\Krakedev\\Programacion_Brandon-modulo5\\POO\\Clases\\img\\nvidia.jpg",
            "C:\\Users\\darck\\Documents\\Krakedev\\Programacion_Brandon-modulo5\\POO\\Clases\\img\\razer.jpg"
        ]
    ...
    def setup_ui(self):
        ...
        ttk.Entry(self.root, textvariable=self.tarj_graf).grid(row=3,column=1)   

        ttk.Label(self.root, text = "Precio").grid(row=4,column=0)
        self.precio = tk.StringVar()
        ttk.Entry(self.root, textvariable=self.precio).grid(row=4,column=1)       

        ttk.Button(self.root, text = "Agregar Laptop", command=self.agregar_laptop).grid(row=5, column=1)
    ...
    def agregar_laptop(self):
        nueva_laptop = Laptop_Gaming(self.marca.get(), self.procesador.get(), self.memoria.get(), self.tarj_graf.get(), self.precio.get())
